    ...
    <section className="movieTypeContainer">
      {props.isSwitched ? (
        <div className="searchForm__movieType-container">
          <button
            className="searchForm__movieTypeBtn"
            onClick={isMatchedPath ? SwitchMovieTypeHandler : SwitchSavedMovieTypeHandler}></button>
          <p className="searchForm__movieType">Полнометражки</p>
        </div>
      ) : (
        <div className="searchForm__movieType-container">
          <button
            className="searchForm__movieTypeBtn searchForm__movieTypeShort"
            onClick={isMatchedPath ? SwitchMovieTypeHandler : SwitchSavedMovieTypeHandler}></button>
